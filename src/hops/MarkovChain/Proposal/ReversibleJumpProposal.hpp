...
//        }
    ...
    template<typename ProposalImpl>
    void ReversibleJumpProposal<ProposalImpl>::setState(const VectorType &state) {
...
//
//    template<typename MarkovChainImpl, typename Model>
//    double ReversibleJumpProposal<MarkovChainImpl, Model>::jumpModel(RandomNumberGenerator &randomNumberGenerator,
//                                                                     std::vector<int> &proposalActivationState,
//                                                                     VectorType &proposal,
//                                                                     const VectorType &defaultValues) {
