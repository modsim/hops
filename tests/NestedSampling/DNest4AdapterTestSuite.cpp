...
//                    delete posteriorSampler;
                ...
                ModelImpl() {
                    ...
                    StateType b(2);
                    b << 5, 5;
                    hops::MultivariateGaussianModel<Eigen::MatrixXd, StateType> gaussian(mean, covariance);

                    priorSampler = new hops::MetropolisHastingsFilter(
                            hops::DikinProposal<decltype(A), decltype(b)>(A, b, mean));
                    posteriorSampler = new hops::ModelMixin(
                                    hops::DikinProposal<decltype(A), decltype(b)>(A, b, mean),
                                    gaussian
                    );
                }

                hops::MetropolisHastingsFilter<hops::DikinProposal<Eigen::MatrixXd, Eigen::VectorXd>>
                *getPriorSampler() const {
                    return priorSampler;
                }

                hops::ModelMixin<hops::DikinProposal<Eigen::MatrixXd, Eigen::VectorXd>, hops::MultivariateGaussianModel<Eigen::MatrixXd, Eigen::VectorXd>>
            ...
            private:
                ...
                hops::MetropolisHastingsFilter<hops::DikinProposal<Eigen::MatrixXd, Eigen::VectorXd>> *priorSampler;
                hops::ModelMixin<hops::DikinProposal<Eigen::MatrixXd, Eigen::VectorXd>, hops::MultivariateGaussianModel<Eigen::MatrixXd, Eigen::VectorXd>> *posteriorSampler;
            };
